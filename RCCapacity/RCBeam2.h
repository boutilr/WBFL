...
public:
   ...
   STDMETHOD(get_RebarLayerEs)(/*[in]*/ IndexType index,/*[out,retval]*/ Float64 * Es) override;
   STDMETHOD(get_RebarLayerFy)(/*[in]*/ IndexType index,/*[out,retval]*/ Float64 * Fy) override;
