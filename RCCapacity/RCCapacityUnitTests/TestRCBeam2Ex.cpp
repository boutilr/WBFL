...
namespace RCCapacityUnitTests
{
	...
	public:
		...
		TEST_METHOD(Test)
		{
         ...
         Float64 val;
         Float64 val1, val2, val3, val4, val5;
         IndexType count;
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(-10, 10, 1.99948e+11, 4.137e+8, 1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(10, -10, 1.99948e+11, 4.137e+8, 1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(10, 10, 1.99948e+11, 4.137e+8, -1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(40, 40, 1.99948e+11, 4.137e+8, 2.0));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(10, 10, 1.99948e+11, 4.137e+8, 1.0));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(20, 20, 1.99948e+11, 4.137e+8, 0.5));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(30, 30, 1.99948e+11, 4.137e+8, 0.0));
         ...
         Assert::AreEqual(E_INVALIDARG, beam->GetRebarLayer(-1, &val1, &val2, &val3, &val4, &val5));
         Assert::AreEqual(E_INVALIDARG, beam->GetRebarLayer(10, &val1, &val2, &val3, &val4, &val5));
         Assert::AreEqual(E_POINTER, beam->GetRebarLayer(1, nullptr, &val2, &val3, &val4, &val5));
         Assert::AreEqual(E_POINTER, beam->GetRebarLayer(1, &val1, nullptr, &val3, &val4, &val5));
         Assert::AreEqual(E_POINTER, beam->GetRebarLayer(1, &val1, &val2, nullptr, &val4, &val5));
