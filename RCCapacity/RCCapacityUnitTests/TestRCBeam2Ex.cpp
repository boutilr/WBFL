...
namespace RCCapacityUnitTests
{
	...
	public:
		...
		TEST_METHOD(Test)
		{
         ...
         IndexType count;
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(-10, 10, 0, 0, 1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(10, -10, 0, 0, 1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(10, 10, 0, 0, -1.0));
         Assert::AreEqual(E_INVALIDARG, beam->AddRebarLayer(40, 40, 0, 0, 2.0));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(10, 10, 0, 0, 1.0));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(20, 20, 0, 0, 0.5));
         Assert::AreEqual(S_OK, beam->AddRebarLayer(30, 30, 0, 0, 0.0));
